...
/*
  ...
  Personal Answer: to ensure that the number that is being pushed to the factors
    array evenly divides the number - or is a factor of the argument given.
*/
function factorsReplacement(number) {
  let divisor = number;
  let factors = [];
  while (divisor > 0) {
    if (number % divisor === 0) {
